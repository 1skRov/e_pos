  ...
  <div style="width:100%; display: flex; justify-content: space-between; height: 100%; overflow: hidden">
    ...
    <div style="width: 50%; height: 100%; overflow-y: auto; padding: 0 12px">
      ...
      <div v-else>
        ...
        <div class="add-products" style="display: flex; flex-direction: column; gap: 12px; margin-top: 12px;">
          <div class="product" v-for="item in selectedItems" :key="item.id" style="align-items: center; gap: 12px">
